...
module.exports = {
  ...
  execute: async(client, message, args, data, db) => {
    ...
    if (data.joinedDate !== null && timeout - (Date.now() - data.joinedDate) > 999) {
      ...
      .setDescription(`<a:warn:726379947601559602>You will lose coins if you leave now<a:warn:726379947601559602>`)
      .addField(`⏰Time left:`, time.join(", "), false)
      message.channel.send(embed)    } else {
      let embed = new Discord.RichEmbed()
      .setColor(process.env.PINK)
      .setTitle(`⏰ Time | ${message.author.username} ⏰`)
      .setDescription(`<a:tick:709282375489814529> You can leave this server Safely <a:tick:709282375489814529>`)
