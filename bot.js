...
client.on("message", msg =>{
  let emmbed = new Discord.RichEmbed()
    ...
    .setDescription(`<:dot:708360553952837665>My Default Prefix is : -\n<:dot:708360553952837665>Do \`-help\` To Get Help Page\n<:dot:708360553952837665>Do \`-invite\` To invite me to server And gain members\n\n<:dot:708360553952837665>\`Support\`: **__[Support Server](https://discord.gg/8K625YF)__** | **__[Invite The Bot](https://discord.com/oauth2/authorize?client_id=714487153475977276&scope=bot&permissions=8)__** | **__[Vote for Bot](https://top.gg/bot/714487153475977276/vote)__**`)
